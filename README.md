...
Supported video codecs: AVC (`avc1`, `avc3`) and HEVC (`hvc1`, `hev1`). For files without STSS data or for audio-only tracks, the original STSS list is used as-is without NAL filtering.
